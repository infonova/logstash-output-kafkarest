...
| <<plugins-{type}s-{plugin}-use_schema>> |<<boolean,boolean>>|No
...
Use value schema validation by setting a corresponding schema ID. If set the `Content-Type` of the request will be
`application/vnd.kafka.jsonschema.v2+json`. Otherwise the `Content-Type` is `application/vnd.kafka.json.v2+json`.
